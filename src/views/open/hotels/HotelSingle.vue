        ...
        <div class="container">
          <nav class="py-3" aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter mb-0 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
              <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="hotel-single-v1.html#">Home</a></li>
              <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="hotel-single-v1.html#">Hotels</a></li>
              <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="hotel-single-v1.html#">London Hotels</a></li>
        ...
        <div class="row">
          <div class="col-lg-8 col-xl-9">
            <div class="d-block d-md-flex flex-center-between align-items-start mb-2">
              <div class="mb-3">
                ...
                <div class="d-block d-md-flex flex-horizontal-center font-size-14 text-gray-1">
                  ...
                  <a href="hotel-single-v1.html#" class="ml-1 d-block d-md-inline"> - View on map</a>
                </div>
              </div>
            ...
            <div class="border-bottom py-4">
                    ...
                    <div class="col col-md-7 col-lg-7 col-xl-5 flex-horizontal-center pl-xl-0">
                      <div class="w-100 position-relative m-4 m-md-0">
                        ...
                        <div class="mt-1 pt-2">
                          ...
                          <!-- On Target Modal -->
                          <a class="font-size-14 text-underline d-block" href="hotel-single-v1.html#ontargetModal"
                             data-modal-target="#ontargetModal"
                             data-modal-effect="fadein">
                            Room Photos and Details
                          </a>
                          <div id="ontargetModal" class="js-modal-window u-modal-window u-modal-window-custom container"
                                  ...
                                  <div class="border-bottom">
                                    <div class="px-4 py-4">
                                      ...
                                      <div class="mt-2">
                                        ...
                                        <span class="font-weight-bold font-size-24">£350.00</span>
                                  ...
                                  <div class="pl-4 pt-4 h-100">
                                    ...
                                    <div class="js-scrollbar height-570">
                                      <ul class="d-block list-unstyled">
                                        ...
                                        <li class="mb-3">
                                          <i class="flaticon-wine-glass mr-3 text-primary font-size-24"></i>Mini bar
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-hamburger mr-3 text-primary font-size-24"></i>Restaurent
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-bathrobe mr-3 text-primary font-size-24"></i>Bathrobes
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-folded-towel mr-3 text-primary font-size-24"></i>Dry cleaning
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-desk-chair mr-3 text-primary font-size-24"></i>High chair
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-slippers mr-3 text-primary font-size-24"></i>Slipper
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-alarm mr-3 text-primary font-size-24"></i>Wakeup call
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-phone-call mr-3 text-primary font-size-24"></i>Telephone
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-air-conditioner mr-3 text-primary font-size-24"></i>AirConditioning
                                        </li>
                                        <li class="mb-3">
                                          <i class="flaticon-hamburger mr-3 text-primary font-size-24"></i>Restaurent
                                        </li>
              ...
              <div class="card border-co border-0lor-7 mb-5 overflow-hidden">
                <div class="position-absolute top-0 right-0 mr-md-1 mt-md-1">
            ...
            <div class="border-bottom py-4">
                ...
                <div class="media-body text-center text-md-left">
                  <div class="mb-4">
                    <h6 class="font-weight-bold text-gray-3">
                      <a href="hotel-single-v1.html#">Helena</a>
                    </h6>
              ...
              <div class="media flex-column flex-md-row align-items-center align-items-md-start mb-0">
                ...
                <div class="media-body text-center text-md-left">
                  <div class="mb-4">
                    <h6 class="font-weight-bold text-gray-3">
                      <a href="hotel-single-v1.html#">Ashleigh</a>
                    </h6>
                    <div class="font-weight-normal font-size-14 text-gray-9 mb-2">April 25, 2019 at 10:46 am</div>
                    <div class="d-flex align-items-center flex-column flex-md-row mb-2">
                      <button type="button" class="btn btn-xs btn-primary rounded-xs font-size-14 py-1 px-2 mr-2 mb-2 mb-md-0">4.6 /5 </button>
              ...
              <div class="flex-horizontal-center">
                <ul class="ml-n1 list-group list-group-borderless list-group-horizontal custom-social-share">
                  <li class="list-group-item px-1 py-0">
                    <a href="hotel-single-v1.html#" class="height-45 width-45 border rounded border-width-2 flex-content-center">
                    ...
                    <div class="border-bottom border-width-2 border-color-1">
                      ...
                      <div id="basicDropdownClick" class="dropdown-menu dropdown-unfold col m-0" aria-labelledby="basicDropdownClickInvoker">
                        ...
                        <div class="w-100 text-right py-1 pr-5">
                          <a class="text-primary font-weight-semi-bold font-size-16" href="hotel-single-v1.html#">Done</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="px-2 pt-2">
                  ...
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <h6 class="mb-0 font-size-14 text-gray-1">
                      <a href="hotel-single-v1.html#">Better than 99% of properties in London</a>
                    </h6>
                  </div>
                  <div class="d-flex align-items-center mb-2">
                    <i class="flaticon-medal font-size-25 text-primary mr-3 pr-1"></i>
                    <h6 class="mb-0 font-size-14 text-gray-1">
                      <a href="hotel-single-v1.html#">Exceptional location - Inside city center</a>
                    </h6>
                  </div>
                  <div class="d-flex align-items-center mb-2">
                    <i class="flaticon-home font-size-25 text-primary mr-3 pr-1"></i>
                    <h6 class="mb-0 font-size-14 text-gray-1">
                      <a href="hotel-single-v1.html#">Popular neighborhood</a>
                    </h6>
                  </div>
                </div>
              </div>
                ...
                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                  <div class="position-relative">
                    ...
                    <div class="position-absolute bottom-0 left-0 right-0">
                      <div class="px-4 pb-3">
                        <a href="hotel-single-v1.html" class="d-block">
                  ...
                  <div class="card-body px-4 pt-2 pb-3">
                    ...
                    <a href="hotel-single-v1.html" class="card-title font-size-17 font-weight-medium text-dark">Empire Prestige Causeway Bay</a>
                    <div class="mt-2 mb-3">
              ...
              <div class="js-slide py-3">
                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                  <div class="position-relative">
                    ...
                    <div class="position-absolute bottom-0 left-0 right-0">
                      <div class="px-4 pb-3">
                        <a href="hotel-single-v2.html" class="d-block">
                          <div class="d-flex align-items-center font-size-14 text-white">
                  ...
                  <div class="card-body px-4 pt-2 pb-3">
                    ...
                    <a href="hotel-single-v2.html" class="card-title font-size-17 font-weight-medium text-dark">Park Avenue Baker Street London</a>
                    <div class="mt-2 mb-3">
                      <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                      <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                    </div>
              ...
              <div class="js-slide py-3">
                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                  <div class="position-relative">
                    ...
                    <div class="position-absolute bottom-0 left-0 right-0">
                      <div class="px-4 pb-3">
                        <a href="hotel-single-v3.html" class="d-block">
                          <div class="d-flex align-items-center font-size-14 text-white">
                            <i class="icon flaticon-placeholder mr-2 font-size-20"></i> Istanbul, Turkey
                          </div>
                        </a>
                  ...
                  <div class="card-body px-4 pt-2 pb-3">
                    ...
                    <a href="hotel-single-v3.html" class="card-title font-size-17 font-weight-medium text-dark">New Road Hotel</a>
                    <div class="mt-2 mb-3">
                      <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                      <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                    </div>
              ...
              <div class="js-slide py-3">
                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                  ...
                  <div class="card-body px-4 pt-2 pb-3">
                    ...
                    <a href="hotel-single-v2.html" class="card-title font-size-17 font-weight-medium text-dark">New York Marriott Downtown</a>
                    <div class="mt-2 mb-3">
                      <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                      <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                    </div>
              ...
              <div class="js-slide py-3">
                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                  ...
                  <div class="card-body px-4 pt-2 pb-3">
                    ...
                    <a href="hotel-single-v3.html" class="card-title font-size-17 font-weight-medium text-dark">Empire Prestige Causeway Bay</a>
                    <div class="mt-2 mb-3">
                      <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                      <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                    </div>
              ...
              <div class="js-slide py-3">
                <div class="card transition-3d-hover shadow-hover-2 w-100 mt-2">
                  ...
                  <div class="card-body px-4 pt-2 pb-3">
                    ...
                    <a href="hotel-single-v1.html" class="card-title font-size-17 font-weight-medium text-dark">New York Marriott Downtown</a>
                    <div class="mt-2 mb-3">
                      <span class="badge badge-pill badge-primary py-1 px-2 font-size-14 border-radius-3 font-weight-normal">4.6/5</span>
                      <span class="font-size-14 text-gray-1 ml-2">(166 reviews)</span>
                    </div>
