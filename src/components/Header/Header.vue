          ...
          <div class="ml-auto d-flex align-items-center">
                      ...
                      <div class="card-footer p-0">
                        <div class="card-footer__top border-bottom border-color-8 py-3">
                          ...
                          <div class="d-flex mb-3">
                            <a class="btn btn-block btn-sm btn-facebook transition-3d-hover" href="hotel-booking.html#">
                              <span class="fab fa-facebook-f mr-2"></span>
                              Facebook
                            </a>
                            <a class="btn btn-block btn-sm btn-twitter transition-3d-hover ml-5 mt-0" href="hotel-booking.html#">
                    ...
                    <div id="signup" style="opacity: 0; display: none;" data-target-group="idForm">
                      ...
                      <div class="card-body pt-5 pb-4">
                        <ul class="nav nav-default nav-pills nav-white nav-justified nav-rounded-pill font-weight-medium px-6 pb-5" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" id="pills-one-code-sample-tab" data-toggle="pill" href="hotel-booking.html#pills-one-code-sample" role="tab" aria-controls="pills-one-code-sample" aria-selected="true">Normal User</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="pills-two-code-sample-tab" data-toggle="pill" href="hotel-booking.html#pills-two-code-sample" role="tab" aria-controls="pills-two-code-sample" aria-selected="false">Partner User</a>
                          </li>
                        </ul>
                          ...
                          <div class="tab-pane fade active show" id="pills-one-code-sample" role="tabpanel" aria-labelledby="pills-one-code-sample-tab">
                            ...
                            <div class="d-flex justify-content-between mb-1">
                              <div class="custom-control custom-checkbox custom-control-inline">
                                ...
                                <label class="custom-control-label" for="customCheckboxInline2">I have read and accept the <a href="hotel-booking.html#">Terms and Privacy Policy</a></label>
                              </div>
                            </div>
                          </div>
                          <div class="tab-pane fade" id="pills-two-code-sample" role="tabpanel" aria-labelledby="pills-two-code-sample-tab">
                            ...
                            <div class="d-flex justify-content-between mb-1">
                              <div class="custom-control custom-checkbox custom-control-inline">
                                ...
                                <label class="custom-control-label" for="customCheckboxInline3">I have read and accept the <a href="hotel-booking.html#">Terms and Privacy Policy</a></label>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="position-relative pl-3 language-switcher dropdown-connector-xl u-header__topbar-divider--dark">
              ...
              <div id="languageDropdown" class="dropdown-menu dropdown-unfold dropdown-menu-right mt-0" aria-labelledby="languageDropdownInvoker">
                <a class="dropdown-item" href="hotel-booking.html#">USD</a>
                <a class="dropdown-item active" href="hotel-booking.html#">EUR</a>
                <a class="dropdown-item" href="hotel-booking.html#">TUR</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <ul class="navbar-nav u-header__navbar-nav">
              ...
              <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                ...
                <ul id="hotelSubMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu-rounded u-header__sub-menu-bordered hs-sub-menu-right u-header__sub-menu--spacer" aria-labelledby="hotelMenu" style="min-width: 230px;">
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="hotel-list.html">Sidebar</a></li>
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="hotel-list-02.html">List With Map</a></li>
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="hotel-single-v1.html">Hotel Single v1</a></li>
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="hotel-single-v2.html">Hotel Single v2</a></li>
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="hotel-single-v3.html">Hotel Single v3</a></li>
                  <li><a class="nav-link u-header__sub-menu-nav-link" href="hotel-booking.html">Hotel Booking</a></li>
                </ul>
                <!-- End Hotel Submenu -->
              </li>
              <!-- End Hotel -->
                    ...
                    <div class="col-12 col-xl">
                      ...
                      <div class="u-header__banner u-header__banner-no-overlay rounded-xs" style="background-image: url(/assets/open/img/240x243/img1.jpg);">
                        <div class="u-header__banner-content u-header__banner-content-not-centered">
                          ...
                          <a class="btn btn-white text-blue btn-sm rounded-xs transition-3d-hover" href="hotel-booking.html#">See Deals</a>
                        </div>
                      </div>
                      <!-- End Banner Image -->
                    </div>
              ...
              <div class="card">
                ...
                <div class="card-footer border-0 p-3 px-md-5 py-md-4">
                  ...
                  <div class="d-md-flex button-inline-group-md mb-1">
                    <a class="btn btn-block btn-md btn-gray-1 rounded-xs font-weight-bold transition-3d-hover" href="hotel-booking.html#">
                      View cart
                    </a>
                    <a class="btn btn-block btn-md btn-blue-1 rounded-xs font-weight-bold transition-3d-hover mt-md-0 ml-md-5" href="hotel-booking.html#">
                      Check Out
                    </a>
                  </div>
                </div>
